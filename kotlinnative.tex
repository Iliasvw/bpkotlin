...
Naast de expect en actual klassen, die ervoor zorgen dat we platformspecifieke code kunnen schrijven, kunnen we ook klassen voorzien die voor alle platformen hetzelfde zijn. Deze klassen zijn dus voor ieder platform hetzelfde.
