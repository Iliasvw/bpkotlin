...
%TODO: link toevoegen naar github%
...
Vooraleer men in Xcode kan gebruik maken van het SharediOS framework, moeten er een aantal dingen aangepast worden in de build phases van het project. Uit figuur \ref{fig:stap6-phases} kan worden afgeleid dat de build phases zijn aangepast. De build phase die moet worden toegevoegd is: Compile Kotlin Native to iOS framework.
\begin{figure} [ht]
	\centering
