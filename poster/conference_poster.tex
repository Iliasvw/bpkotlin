...
\begin{abstract}
Nog niet zo lang geleden had men bij het bouwen van mobiele applicaties (Android, iOS en Windows) enkel en alleen de mogelijkheid om drie aparte applicaties te bouwen, native applicaties. Dit was voor vele bedrijven veel werk en  zeer kostelijk. Als reactie hierop zijn de hybride frameworks uitgevonden, denk maar aan: React, Xamarin en Ionic. Bij deze frameworks moet er maar éénmaal code geschreven worden en het framework zorgde ervoor dat de applicatie op elk besturingssysteem kon draaien. Er mag namelijk nog een framework toegevoegd worden aan het lijstje van hybride frameworks, namelijk Kotlin/Native.
